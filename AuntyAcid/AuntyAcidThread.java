 ...
 */
public class AuntyAcidThread extends Thread {
    private int threadID;
    private String filesPath;
    private org.joda.time.LocalDate start;
    private org.joda.time.LocalDate end;
    private static String baseURL = "http://www.gocomics.com/aunty-acid/";

    public AuntyAcidThread(int threadID, String filesPath, org.joda.time.LocalDate start, org.joda.time.LocalDate end) {
